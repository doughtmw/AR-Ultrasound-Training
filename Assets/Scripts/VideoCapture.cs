...
public class VideoCapture : MonoBehaviour
{
    ...
    public void Init(int bgWidth, int bgHeight)
    {
        ...
        if (UseWebCam) CameraPlayStartInit();
    }

    /// <summary>
    /// Play Web Camera
    /// </summary>
    public WebCamTexture CameraPlayStart()
    {
    ...
    public void CameraPlayStartInit()
    {
    ...
    private void InitMainTexture()
    {
        ...
        MainTexture = new RenderTexture(bgWidth, bgHeight, 0, RenderTextureFormat.Default, RenderTextureReadWrite.Linear)
        {
            useMipMap = false,
